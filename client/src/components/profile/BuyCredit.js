  ...
  function payWithPaystack(amount) {
    var handler = window.PaystackPop.setup({
      ...
      callback: function (response) {
        //verifyPayment()
        verify(response.reference).then((usefulData) =>
          alert(
            `Your Transaction of ${usefulData.amount} was ${usefulData.message}`
          )
        );
      ...
      <div>
        ...
        >
          <div className="container">
            ...
            <Message success>
              <Message.Header>
                Credit into your Account ballance directly from your Bank
                Account
              </Message.Header>
            </Message>
            <Form onSubmit={(e) => onSubmit(e)}>
              ...
              <Button positive onClick={payWithPaystack} size="massive">
                Pay Now
              </Button>
            </Form>
            <div></div>
